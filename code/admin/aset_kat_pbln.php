            ...
            <div class="card card-default">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <a href="laporan/laporan_aset_kat_bln.php?id=<?=$namak['id_kategori']?>" class="btn btn-primary btn-round ml-auto">
                            <i class="fa fa-plus"></i>
                            Cetak Laporan
                        </a>
                        <a href="laporan/excel_aset_kat_bln.php?id=<?=$namak['id_kategori']?>" class="btn btn-primary btn-round " style="margin-left: 20px">
                            <i class="fa fa-plus"></i>
                            Export Excel
                        </a>
